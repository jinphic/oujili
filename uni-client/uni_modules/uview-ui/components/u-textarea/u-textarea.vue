<template>
    <view class="u-textarea" :class="textareaClass" :style="[textareaStyle]">
        ...
        <text
            ...
            v-if="count"
            >{{ innerValue.length }}/{{ maxlength }}字</text
        >
    </view>
</template>
 ...
 * @property {String}			    placeholderClass		指定placeholder的样式类，注意页面或组件的style中写了scoped时，需要在类名前写>>> （ 默认 'input-placeholder' ）
...
.u-textarea {
    ...
    &__count {
        ...
        font-size: 14px;
        color: $u-tips-color;
        padding: 1px 4px;font-family: 'PingFang SC-Regular, PingFang SC';
    }
}
</style>
